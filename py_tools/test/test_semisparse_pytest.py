...
def rs_test_single_edge_num_distances():
    G = nx.Graph()
    G.add_edge(1, 2)
    num_distances, _ = ss.all_pairs_shortest_paths_rolling_sum(G)
...
def rs_test_disconnected_triads_num_distances():
    G = nx.Graph()
    # First triad
...
def rs_test_three_components_num_distances():
    G = nx.Graph()
    # First triad
    G.add_edges_from([(1, 2), (2, 3), (3, 1)])
    # Second triad
...
def rs_test_three_components_num_distances_2():
    G = nx.Graph()
    # First triad
    G.add_edges_from([(1, 2), (2, 3), (3, 1)])
    # Second triad
...
def rs_test_single_edge_sum_distances():
    G = nx.Graph()
    G.add_edge(1, 2)
    _, sum_distances = ss.all_pairs_shortest_paths_rolling_sum(G)
...
def rs_test_disconnected_triads_sum_distances():
    G = nx.Graph()
    # First triad
    G.add_edges_from([(1, 2), (2, 3), (3, 1)])
    # Second triad
...
def rs_test_three_components_sum_distances():
    G = nx.Graph()
    # First triad
    G.add_edges_from([(1, 2), (2, 3), (3, 1)])
    # Second triad
...
def rs_test_three_components_sum_distances_2():
    G = nx.Graph()
    # First triad
    G.add_edges_from([(1, 2), (2, 3), (3, 1)])
    # Second triad
...
def test_empty_sum_distances():
    G = nx.Graph()
    sum_distances = sum([k*v for k, v in ss.all_pairs_shortest_paths(G).items()])
    assert sum_distances == 0
